...
namespace SanteDB.OrmLite
{
    ...
    public class ColumnMapping
    {
        ...
        /// <summary>
        /// True if the column should be encrypted
        /// </summary>
        public string EncryptedColumnId { get; private set; }
        ...
        private ColumnMapping(PropertyInfo pi, TableMapping table)
        {
            ...
            this.EncryptedColumnId = pi.GetCustomAttribute<ApplicationEncryptAttribute>()?.FieldName;
